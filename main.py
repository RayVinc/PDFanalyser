...
root.geometry("1400x700")  # Increased the width and height
...
pdf_text = tk.Text(viewer_frame, wrap="none", width=80, height=20)  # Increased width
...
def display_entire_pdf(pdf_filepath):
    ...
    for page_num in range(len(pdf_document)):
        ...
        text = page.get_text()
        pdf_text.insert("end", text)  # Append the text
...
chat_text = tk.Text(button_frame, wrap="word", width=80, height=10)  # Increased width
